...
const VENDORS = [
  ...
  { id: 'paidavaar',      name: 'Paidavaar',          badge: 'Crop Protection',           url: 'https://paidavaar.in/',            searchUrl: 'https://paidavaar.in/search?q=',                        linkColor: 'text-blue-500' },
  { id: 'pesticide_india',name: 'Pesticide India',    badge: 'Dedicated Pesticides',      url: 'https://pesticideindia.in/',       searchUrl: 'https://pesticideindia.in/pesticidesproducts',          linkColor: 'text-red-500' },
  { id: 'pestiseeds',     name: 'Pestiseeds Agritech',badge: 'B2B/B2C Agri Products',     url: 'https://pestiseedsagritech.com/', searchUrl: 'https://pestiseedsagritech.com/',                       linkColor: 'text-teal-500' },
  { id: 'agri_search',    name: 'Agri Search India',  badge: 'Bio Fertilizers',           url: 'https://agrisearchindia.com/',     searchUrl: 'https://agrisearchindia.com/en/search/result?q=',       linkColor: 'text-emerald-600' },
  { id: 'matihaat',       name: 'Matihaat',           badge: 'Premium Organic Tools',     url: 'https://matihaat.com/',           searchUrl: 'https://matihaat.com/search?q=',                        linkColor: 'text-lime-600' },
  { id: 'invade',         name: 'Invade Agro Global', badge: 'Global Supply Chain',       url: 'https://invadeagro.in/',           searchUrl: 'https://invadeagro.in/?s=',                            linkColor: 'text-indigo-500' },
]
...
const products = [
  ...
  // ── Paidavaar — verified: /search?q= format ──
  { id:8,  name:'IFFCO Nano Urea Liquid (500 ml)',                                      cat:'Fertilizer',      price:240,  unit:'500 ml',   rating:4.8, brand:'IFFCO',        vendor:'paidavaar',      buyUrl:'https://paidavaar.in/search?q=IFFCO+Nano+Urea',                         icon:<FlaskConical size={28}/> },
  { id:9,  name:'Sumitomo Danitol Insecticide (Fenpropathrin 10% EC)',                  cat:'Pesticide',       price:650,  unit:'1 L',      rating:4.5, brand:'Sumitomo',     vendor:'paidavaar',      buyUrl:'https://paidavaar.in/search?q=Sumitomo+Danitol',                         icon:<Package size={28}/> },
  { id:10, name:'PI Industries Biovita Seaweed Extract',                                cat:'Growth Promoter', price:490,  unit:'500 ml',   rating:4.7, brand:'PI Industries', vendor:'paidavaar',      buyUrl:'https://paidavaar.in/search?q=PI+Biovita+Seaweed',                      icon:<FlaskConical size={28}/> },
  { id:26, name:'Dhanuka Zineb 75% WP Fungicide',                                       cat:'Fungicide',       price:280,  unit:'500 g',    rating:4.5, brand:'Dhanuka',      vendor:'paidavaar',      buyUrl:'https://paidavaar.in/search?q=Dhanuka+Zineb',                           icon:<FlaskConical size={28}/> },

  // ── Pesticide India — no search engine; link to their products catalog page ──
  { id:11, name:'Dhanuka Craze Herbicide (Pretilachlor 50% EC)',                        cat:'Herbicide',       price:310,  unit:'500 ml',   rating:4.6, brand:'Dhanuka',      vendor:'pesticide_india', buyUrl:'https://pesticideindia.in/pesticidesproducts',                          icon:<Package size={28}/> },
  { id:12, name:'Crystal Abacin (Abamectin 1.9% EC)',                                   cat:'Pesticide',       price:480,  unit:'250 ml',   rating:4.5, brand:'Crystal Crop', vendor:'pesticide_india', buyUrl:'https://pesticideindia.in/pesticidesproducts',                          icon:<Package size={28}/> },
  { id:13, name:'Katyayani Imidacloprid 17.8% SL',                                     cat:'Pesticide',       price:400,  unit:'500 ml',   rating:4.6, brand:'Katyayani',    vendor:'pesticide_india', buyUrl:'https://pesticideindia.in/pesticidesproducts',                          icon:<Package size={28}/> },
  { id:27, name:'Bayer Solomon Insecticide (Imidacloprid + Beta Cyfluthrin)',           cat:'Pesticide',       price:720,  unit:'250 ml',   rating:4.7, brand:'Bayer',        vendor:'pesticide_india', buyUrl:'https://pesticideindia.in/pesticidesproducts',                          icon:<Package size={28}/> },

  // ── Pestiseeds Agritech — app-only ordering; link to homepage (no web search) ──
  ...
  { id:15, name:'Nunhems US 33 Tomato Indeterminate Seeds',                             cat:'Seeds',           price:420,  unit:'10 g',     rating:4.8, brand:'Nunhems',      vendor:'pestiseeds',      buyUrl:'https://pestiseedsagritech.com/',                                       icon:<Leaf size={28}/> },
  ...
  { id:28, name:'Syngenta NK 6240 Maize Hybrid Seeds',                                 cat:'Seeds',           price:1650, unit:'4 kg',     rating:4.7, brand:'Syngenta',     vendor:'pestiseeds',      buyUrl:'https://pestiseedsagritech.com/',                                       icon:<Leaf size={28}/> },

  // ── Agri Search India — verified: /en/search/result?q= format ──
  { id:17, name:'Agri Search Mycorrhiza VAM Bio-Fertilizer',                           cat:'Bio Input',       price:220,  unit:'1 kg',     rating:4.7, brand:'Agri Search',  vendor:'agri_search',     buyUrl:'https://agrisearchindia.com/en/search/result?q=Mycorrhiza+VAM',        icon:<Leaf size={28}/> },
  { id:18, name:'Zinc Solubilizing Bacteria (ZSB Liquid)',                             cat:'Bio Input',       price:180,  unit:'1 L',      rating:4.6, brand:'Agri Search',  vendor:'agri_search',     buyUrl:'https://agrisearchindia.com/en/search/result?q=Zinc+Solubilizing+Bacteria', icon:<FlaskConical size={28}/> },
  { id:29, name:'Phosphate Solubilizing Bacteria (PSB Liquid Bio-Fertilizer)',         cat:'Bio Input',       price:160,  unit:'1 L',      rating:4.6, brand:'Agri Search',  vendor:'agri_search',     buyUrl:'https://agrisearchindia.com/en/search/result?q=Phosphate+Bacteria',   icon:<FlaskConical size={28}/> },

  // ── Matihaat — verified: Shopify /search?q= format ──
  { id:19, name:'Cold Pressed Neem Oil Extract (10000 PPM)',                           cat:'Organic',         price:550,  unit:'1 L',      rating:4.8, brand:'Matihaat',     vendor:'matihaat',        buyUrl:'https://matihaat.com/search?q=Neem+Oil+Extract',                       icon:<Leaf size={28}/> },
  { id:20, name:'Trichoderma Viride BioFungicide Premium',                             cat:'Organic',         price:200,  unit:'1 kg',     rating:4.7, brand:'Matihaat',     vendor:'matihaat',        buyUrl:'https://matihaat.com/search?q=Trichoderma+Viride',                     icon:<Leaf size={28}/> },
  { id:21, name:'Pseudomonas Fluorescens Bio Bactericide',                             cat:'Organic',         price:220,  unit:'1 kg',     rating:4.6, brand:'Matihaat',     vendor:'matihaat',        buyUrl:'https://matihaat.com/search?q=Pseudomonas+Fluorescens',               icon:<Leaf size={28}/> },
  { id:30, name:'Vermicompost Premium Organic Soil Enricher',                          cat:'Organic',         price:350,  unit:'5 kg',     rating:4.8, brand:'Matihaat',     vendor:'matihaat',        buyUrl:'https://matihaat.com/search?q=Vermicompost',                           icon:<Leaf size={28}/> },

  // ── Invade Agro — verified: invadeagro.in (not .com) with ?s= WooCommerce format ──
  { id:22, name:'NPK 19:19:19 Water Soluble Fertilizer',                               cat:'Fertilizer',      price:1800, unit:'25 kg',    rating:4.5, brand:'Invade',       vendor:'invade',          buyUrl:'https://invadeagro.in/?s=NPK+19+19+19+Water+Soluble',                  icon:<FlaskConical size={28}/> },
  { id:23, name:'Humic Acid 98% Flakes (Soil Conditioner)',                            cat:'Growth Promoter', price:450,  unit:'1 kg',     rating:4.8, brand:'Invade',       vendor:'invade',          buyUrl:'https://invadeagro.in/?s=Humic+Acid+98+Flakes',                        icon:<FlaskConical size={28}/> },
  { id:24, name:'Global Drip Irrigation Dripper Set (8 LPH)',                          cat:'Equipment',       price:1200, unit:'100 Pcs',  rating:4.9, brand:'Invade',       vendor:'invade',          buyUrl:'https://invadeagro.in/?s=Drip+Irrigation+Dripper',                    icon:<Package size={28}/> },
  { id:31, name:'Potassium Humate 98% Shiny Flakes (K-Humate)',                        cat:'Growth Promoter', price:520,  unit:'1 kg',     rating:4.7, brand:'Invade',       vendor:'invade',          buyUrl:'https://invadeagro.in/?s=Potassium+Humate+Shiny+Flakes',              icon:<FlaskConical size={28}/> },
]
